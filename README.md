...
Just extract the zip file, no installation needed (see below on how to launch it).
...
The URL/subscription worker statuses (the left side) has the following color coding:
| Color | Meaning |
|-------|---------|
